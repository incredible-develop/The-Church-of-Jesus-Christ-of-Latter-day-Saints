...
/*	"nextPage" : function(e) {
	...
	"updateFilterData" : function(renderSum) {
		...
		var uris = [], users = [], a = $("#uriFilterBox input").get(), i = a.length;
		while (i--) {
	...
	"updateButtons" : function(status) {
		if (status === '') {
			...
			var statusActions = C.SETTINGS[status];
