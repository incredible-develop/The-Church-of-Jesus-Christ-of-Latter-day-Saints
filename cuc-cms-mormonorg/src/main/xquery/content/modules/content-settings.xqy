...
module namespace content-settings = "http://lds.org/code/shared/lds-edit/content/content-settings";
 ...
 <content-settings xmlns="http://lds.org/code/lds-edit">
    ...
    <content-workflow xmlns="http://lds.org/code/lds-edit">
        <step title="Created" name="submission-created">
            ...
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-submission-created" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
        ...
        <step title="Submitted" name="submission-submitted">
            ...
            <permission>ldse:add-submission</permission>
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-submission-submitted" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/content/modules/json-snippet.xqy" />
        ...
        <step title="Draft" name="draft">
            <user-filter element-name="created" title="Created By"/>
            <date-filter element-name="created" title="Created Date"/>
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-preview-content-json" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/content/modules/json-snippet.xqy" />
        ...
        <step title="Published" name="publish">
            ...
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-published-content-json" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/content/modules/json-snippet.xqy" />
            <permission>ldse:publish-doc</permission>
        ...
        <step title="Unpublished" name="unpublished">
            ...
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-unpublished-content-json" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/content/modules/json-snippet.xqy" />
        ...
        <step title="Modified" name="modified">
            ...
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-modified-content-json" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/content/modules/json-snippet.xqy" />
            <permission>ldse:add-doc</permission>
            <permission>ldse:view-all-content-manager-statuses</permission>
        ...
        <step title="Scheduled Publish" name="schedule-publish">
            ...
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-scheduled-publish-json" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/content/modules/json-snippet.xqy" />
            <permission>ldse:publish-doc</permission>
            <permission>ldse:view-all-content-manager-statuses</permission>
        ...
        <step title="Scheduled Unpublish" name="schedule-unpublish">
            ...
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-scheduled-unpublish-json" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/shared/lds-edit/content/modules/json-snippet.xqy" />
            <permission>ldse:unpublish-doc</permission>
            <permission>ldse:view-all-content-manager-statuses</permission>
        ...
        <step title="Commented On" name="comments">
            ...
            <transform-results xmlns="http://marklogic.com/appservices/search" apply="build-comment-json" ns="http://lds.org/code/shared/lds-edit/content/json-snippet"
                at="/content/modules/json-snippet.xqy" />
            <permission>ldse:edit-doc</permission>
            <permission>ldse:view-all-content-manager-statuses</permission>
