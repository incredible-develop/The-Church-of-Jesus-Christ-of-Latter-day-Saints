...
/* harmony default export */ __webpack_exports__["a"] = (parseTemplate);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resource_modal_html__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resource_modal_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__resource_modal_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resource_modal_scss__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resource_modal_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__resource_modal_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_parse_template__ = __webpack_require__(1);





class ResourceModal extends HTMLElement {
    constructor() {
        super();
        ...
        const element = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util_parse_template__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0__resource_modal_html___default.a);
        element.querySelector('style').innerHTML = __WEBPACK_IMPORTED_MODULE_1__resource_modal_scss___default.a;
...
ResourceModal.prototype.open = function () {
    this.setAttribute('open', '');
    this.dispatchEvent(this.events.open);
}

ResourceModal.prototype.close = function () {
    this.removeAttribute('open');
    this.dispatchEvent(this.events.close);
}

customElements.define('resource-modal', ResourceModal);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resource_reference_html__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resource_reference_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__resource_reference_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resource_reference_scss__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resource_reference_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__resource_reference_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_parse_template__ = __webpack_require__(1);
...
class ResourceReference extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const element = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util_parse_template__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0__resource_reference_html___default.a);
        element.querySelector('style').innerHTML = __WEBPACK_IMPORTED_MODULE_1__resource_reference_scss___default.a;
        
        const form = element.querySelector('resource-modal form');
        form.setAttribute('method', this.getAttribute('data-method') || 'GET');
        form.setAttribute('action', this.getAttribute('data-url') || '/');

        const { searchId, inputId } = this.dataset;
        if(searchId) {
            this.slotSearch = this.querySelector(`#${searchId}`);
            if(this.slotSearch) {
        ...
        if(inputId) {
            this.slotInput = this.querySelector(`#${inputId}`);
            if(this.slotInput) {
                const input = element.querySelector('x-input');
    ...
    connectedCallback() {
        this.shadowRoot.querySelector('form')
            .addEventListener('submit', (event) => {
                ...
                const { value: query } = this.shadowRoot.querySelector('form input');
                this.search(query);
            });

        
        (this.slotSearch || this.shadowRoot.querySelector('#search'))
            .addEventListener('click', (event) => {
                const modal = this.shadowRoot.querySelector('resource-modal');
                modal.open();
            });
    }
    ...
    static get observedAttributes() {
        return ['data-url', 'data-input-id', 'data-search-id'];
    }
    
    attributeChangedCallback(attrName, oldVal, newVal) {
        if (attrName === 'data-url') {
            // TODO
            // this.element.querySelector('resource-modal');
    ...
    search(query) {
        if(!this.fetch) {
            throw new Error('No fetch function was defined. Use "defineFetch" to define a fetching function');
        }
        this.fetch(query)
            .then(result => {
    ...
    mapResult(result) {
        ...
        const header = modal.querySelector('.results-heading');
        if (header) {
        ...
        results.classList.add('rr-results');
        result.results.forEach(({id, title, type, uri, image: { src } = {}}) => {
            const li = document.createElement('li');
            li.innerHTML = `<resource-result data-id="${id}" data-title="${title}" data-type="${type}" data-uri="${uri || ''}" data-img="${src ? `${src}` : ''}"></resource-result>`;
            li.addEventListener('click', (event) => {
                const id = li.querySelector('resource-result').getAttribute('data-id');
                (this.slotInput || this.shadowRoot.getElementById('resource-id'))
                    .value = id;
                modal.close();
            });
            results.appendChild(li);
        });
        const existing = modal.querySelector('.rr-results');
        if(existing) {
...
ResourceReference.prototype.defineFetch = function(fn) {
    this.fetch = fn;
}

customElements.define('resource-reference', ResourceReference);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resource_result_html__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resource_result_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__resource_result_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resource_result_scss__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resource_result_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__resource_result_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_parse_template__ = __webpack_require__(1);
...
class ResourceResult extends HTMLElement {
    constructor() {
        ...
        const element = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util_parse_template__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0__resource_result_html___default.a);
        element.querySelector('style').innerHTML = __WEBPACK_IMPORTED_MODULE_1__resource_result_scss___default.a;

        element.querySelector('a')
            .setAttribute('href', `${this.getAttribute('data-uri') || ''}`);

        element.querySelector('img')
            .setAttribute('src', this.getAttribute('data-img'));

        element.getElementById('title')
            .innerHTML = this.getAttribute('data-title');
        
        element.getElementById('type')
            .innerHTML = this.getAttribute('data-type');

        if (this.getAttribute('data-uri')) {
            element.getElementById('uri')
                .innerHTML = this.getAttribute('data-uri');
        } else {
...
customElements.define('resource-result', ResourceResult);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__x_input_html__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__x_input_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__x_input_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__x_input_scss__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__x_input_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__x_input_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_parse_template__ = __webpack_require__(1);
...
class XInput extends HTMLElement {
    constructor() {
        ...
        const element = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util_parse_template__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0__x_input_html___default.a);
        element.querySelector('style').innerHTML = __WEBPACK_IMPORTED_MODULE_1__x_input_scss___default.a;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__webcomponents_webcomponentsjs__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_resource_reference_src_resource_reference_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_resource_modal_src_resource_modal_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_resource_result_src_resource_result_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_x_input_src_x_input_js__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ResourceReference: __WEBPACK_IMPORTED_MODULE_1__components_resource_reference_src_resource_reference_js__["default"],
    ResourceModal: __WEBPACK_IMPORTED_MODULE_2__components_resource_modal_src_resource_modal_js__["default"],
    ResourceResult: __WEBPACK_IMPORTED_MODULE_3__components_resource_result_src_resource_result_js__["default"],
    XInput: __WEBPACK_IMPORTED_MODULE_4__components_x_input_src_x_input_js__["default"]
});
...
module.exports = "<template>\n    <style></style>\n    <slot></slot>\n    <div class=\"input-group\">\n        <button class=\"rr-btn\" type=\"button\" id=\"search\">Search</button>\n    </div>\n    <div class=\"input-group\">\n        <label for=\"resource-id\">Resource ID</label>\n        <x-input>\n            <input class=\"rr-input\" type=\"text\" id=\"resource-id\">\n        </x-input>\n    </div>\n    <resource-modal>\n        <form class=\"rr-form\" method=\"\" action=\"\">\n            <input class=\"rr-input\" type=\"text\" name=\"query\" required>\n            <button class=\"rr-btn\" type=\"submit\">Search</button>\n        </form>\n    </resource-modal>\n</template>";

/***/ }),
/* 18 */
/***/ (function(module, exports) {

module.exports = "<template>\n    <style></style>\n    <section class=\"brand section\">\n        <p id=\"type\" class=\"type\"></p>\n    </section>\n    <section class=\"image section\">\n        <img src=\"xxxHTMLLINKxxx0.24513818957088350.16896119476596216xxx\" alt=\"\">\n    </section>\n    <section class=\"details section\">\n        <h1 id=\"title\" class=\"title\"></h1>\n        <a href=\"\" id=\"uri\" class=\"uri\" target=\"_blank\"></a>\n    </section>\n</template>";

/***/ }),
/* 19 */
/***/ (function(module, exports) {

module.exports = "<template>\n    <style></style>\n    <slot></slot>\n    <span id=\"clear\" tabindex=\"0\">&times;</span>\n</template>";
