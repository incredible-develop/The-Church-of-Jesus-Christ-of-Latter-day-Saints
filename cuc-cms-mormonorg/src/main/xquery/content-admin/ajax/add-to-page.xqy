...
declare variable $region as xs:string? := util:escape-chars(xdmp:get-request-field('region'))[. != ''];
declare variable $id as xs:string* := util:escape-chars(xdmp:get-request-field('id'));
declare variable $clone as xs:string? := util:escape-chars(xdmp:get-request-field('clone'))[. != ''];
declare variable $site as xs:string? := util:escape-chars(xdmp:get-request-field('site'))[. != ''];

af:add-to-custom-page($locale, $uri, $id, $clone, $region, $site)
