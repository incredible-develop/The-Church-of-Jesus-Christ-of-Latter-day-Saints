xquery version "3.0";
module namespace mofc = "http://lds.org/code/shared/lds-edit/mormonOrgFormComponents";
declare function mofc:get-mormon-org-form-components(
)
{
    (
        <mo-form-address-block>Address Block</mo-form-address-block>,
        <mo-form-address-field>Address Field</mo-form-address-field>,
        ...
        <mo-form-location-field>Location Field</mo-form-location-field>,
        ...
        <mo-button>Submit Button</mo-button>,
